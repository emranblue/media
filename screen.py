...
class ScreenRecord(FFMPEG_VideoWriter):
    ...
    def __init__(self,filename=None,box=None,custom_box=False,fps=15,**kwargs):
        digest_config(self,kwargs)
        FFMPEG_VideoWriter.__init__(self,filename=self.filename,fps=self.fps if fps is None else fps,rgb=self.rgb,**kwargs)
